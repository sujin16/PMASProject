...
class Ui_wifiDialog(object):
    def setupUi(self, wifiDialog):
        ...
        self.connect_pushButton = QtWidgets.QPushButton(self.main_wifi_frame)
        self.connect_pushButton.setGeometry(QtCore.QRect(130, 220, 121, 23))
    ...
    def retranslateUi(self, wifiDialog):
        ...
        self.connect_pushButton.setText(_translate("wifiDialog", "Connect"))
